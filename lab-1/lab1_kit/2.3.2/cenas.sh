...
# from results.txt, get the MISS_RATE, PRICE and COST for the two cheapest COST values
...
echo "CHEAPEST_COST: $CHEAPEST_COST"
echo "SECOND_CHEAPEST_COST: $SECOND_CHEAPEST_COST"
